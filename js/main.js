...
// content-box hover show btn name
...
if (contentBox && taskBtnEl && packageBtnEl && mailBtnEl) {
    taskBtnEl.addEventListener('mouseenter', () => {
        contentBox.textContent = 'Task';
        contentBox.style.opacity = '1';
        contentBox.style.pointerEvents = 'auto';
    });
    taskBtnEl.addEventListener('mouseleave', () => {
        contentBox.style.opacity = '0';
        contentBox.style.pointerEvents = 'none';
    });
    packageBtnEl.addEventListener('mouseenter', () => {
        contentBox.textContent = 'Package';
        contentBox.style.opacity = '1';
        contentBox.style.pointerEvents = 'auto';
    });
    packageBtnEl.addEventListener('mouseleave', () => {
        contentBox.style.opacity = '0';
        contentBox.style.pointerEvents = 'none';
    });
    mailBtnEl.addEventListener('mouseenter', () => {
        contentBox.textContent = 'Mail';
        contentBox.style.opacity = '1';
        contentBox.style.pointerEvents = 'auto';
    });
    mailBtnEl.addEventListener('mouseleave', () => {
        contentBox.style.opacity = '0';
        contentBox.style.pointerEvents = 'none';
    });
}
